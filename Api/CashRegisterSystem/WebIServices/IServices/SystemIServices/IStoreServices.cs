...
{
    public interface IStoreServices : IBaseService
    {
        /// <summary>
        /// 获取商店列表
        /// </summary>
        ...
        /// <returns></returns>
        Task<ApiResponse<bool>> AddStoreAsync(sys_store sys_Store);
        /// <summary>
        /// 删除商店
        /// </summary>
        ...
        ///修改商店
        ///<summary>
        Task<ApiResponse<bool>> UpdateStoreAsync(sys_store sys_Store);

...
namespace MyNamespace
{
    ...
    ///厨房订单表（KDS系统同步）
    ///</summary>
    [SugarTable("sys_kitchen_order")]
    public partial class sys_kitchen_order
    {
        public sys_kitchen_order()
        {
        ...
        [Navigate(NavigateType.OneToOne, nameof(cook_id), nameof(sys_staff.staff_id))]//一对一 
        public sys_staff? cook { get; set; }
        
        [Navigate(NavigateType.OneToOne, nameof(picker_id), nameof(sys_staff.staff_id))]//一对一 
        public sys_staff? picker { get; set; }
